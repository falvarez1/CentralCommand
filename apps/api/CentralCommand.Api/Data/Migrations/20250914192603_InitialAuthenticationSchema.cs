        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestrictedPortals = table.Column<string>(type: "jsonb", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000001"), null, "SuperAdmin", "SUPERADMIN" },
                    { new Guid("00000000-0000-0000-0000-000000000002"), null, "Admin", "ADMIN" },
                    { new Guid("00000000-0000-0000-0000-000000000003"), null, "Manager", "MANAGER" },
                    { new Guid("00000000-0000-0000-0000-000000000004"), null, "Developer", "DEVELOPER" },
                    { new Guid("00000000-0000-0000-0000-000000000005"), null, "Analyst", "ANALYST" },
                    { new Guid("00000000-0000-0000-0000-000000000006"), null, "Viewer", "VIEWER" },
                    { new Guid("00000000-0000-0000-0000-000000000007"), null, "Guest", "GUEST" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAuditLogs_EntityType",
                schema: "auth",
                table: "UserAuditLogs",
                column: "EntityType");

            migrationBuilder.CreateIndex(
                name: "IX_UserAuditLogs_EntityType_EntityId",
                schema: "auth",
                table: "UserAuditLogs",
